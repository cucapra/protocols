...
def picorv32_pcpi_mul():
    ...
    m.transactions = [
        ...
        Transaction("pcpi_mulh", [rs1, rs2], [("rd_data", Slice(63, 32, SignExt(32, rs1) * SignExt(32, rs2)))]),
        Transaction("pcpi_mulhu", [rs1, rs2], [("rd_data", Slice(63, 32, ZeroExt(32, rs1) * ZeroExt(32, rs2)))]),
        Transaction("pcpi_mulhsu", [rs1, rs2], [("rd_data", Slice(63, 32, SignExt(32, rs1) * ZeroExt(32, rs2)))]),
    ]
    return m
